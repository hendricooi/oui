...
$_SESSION['return_to'] = $_SERVER['REQUEST_URI'];
    ...
    $Underfill = array_search($Underfill, get_defined_vars());
    $response=makeCurlRequest("RequestEquipmentListArea",$Underfill);
    $sideEq= Section::convertJsonToListView($Underfill,$response);
...
echo"<div class='container'>";
    ...
    echo "<div class='content'>";
        $display=Section::displayEquipmentInfo($Underfill,$response);
        echo $display;
